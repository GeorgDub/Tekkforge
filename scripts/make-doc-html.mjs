...
<section class="seite">
  ...
  ${img("boot-panel", "Boot-Sektor und BOOT.VSB in der Werkbank: Starter laden, prüfen, verpacken — mit dem Warnhinweis, dass dieser Weg keinen Rückweg außer JTAG hat.")}
