...
<section class="seite">
  ...
  <p>Die Firmware trägt außer den Presets noch drei Dinge, die sich austauschen lassen: die <b>Groove-Vorlagen</b> (mit eigenen Zählern, wie die Presets), das <b>Init-Pattern</b> — der Block, den das Gerät für jedes neue Pattern nimmt, also Tempo, Länge, Part-Einstellungen und Motion, wie man sie im Editor eingestellt hat — und den <b>Startbildschirm</b>, 128 × 64 Pixel beim Einschalten. Die Werkbank lädt eine Basis, prüft ihre Struktur (auch eine frühere TekkForge-Fassung taugt, die nächste Runde baut darauf auf), und brennt ein, was angehakt ist. Für den Startbildschirm gibt es einen Pixel-Editor: malen mit der Maus, ein Bild einpassen und nach Helligkeit schwellen, oder das Logo aus der Basis holen. Die Bit-Belegung des Bildes ist am Original-Decoder bewiesen — das Hacktribe-Logo geht byte-genau hin und zurück. Und wer sich am Gerät im Arbeitsspeicher etwas zusammengebaut und gehört hat, brennt es in einem Schritt ein: die Komplettsicherung erfasst jetzt auch Zähler, Init-Pattern und Startbild, und die Werkbank legt eine solche Sicherung als Ganzes in die Basis. Zwei Firmwares lassen sich außerdem nebeneinanderhalten: welche Plätze, Zähler, Init-Pattern und Startbild sich unterscheiden, und was außerhalb der bekannten Bereiche liegt — so wird sichtbar, was ein Bau wirklich verändert hat.</p>
